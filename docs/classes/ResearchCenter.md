...
_A research center or institute._
...
URI: [schema:ResearchOrganization](http://schema.org/ResearchOrganization)
...
```mermaid
 classDiagram
    ...
    click ResearchCenter href "../../classes/ResearchCenter/"
      ...
      ResearchCenter : additional_urls
        
      ResearchCenter : contact_email
      ...
      ResearchCenter : description
        ...
        ResearchCenter --> "*" LangString : description
        click LangString href "../../classes/LangString/"
    

        
      ResearchCenter : homepage
        
      ResearchCenter : id
        
      ResearchCenter : identifiers
      ...
      ResearchCenter : location
        ...
        ResearchCenter --> "0..1" Location : location
      ...
      ResearchCenter : name
        ...
        ResearchCenter --> "*" LangString : name
        click LangString href "../../classes/LangString/"
    

        
      ResearchCenter : organization_type
        
          
    
        
        
        ResearchCenter --> "0..1" OrganizationTypeEnum : organization_type
        click OrganizationTypeEnum href "../../enums/OrganizationTypeEnum/"
    

        
      ResearchCenter : parent_organization
        
          
    
        
        
        ResearchCenter --> "0..1" Organization : parent_organization
        click Organization href "../../classes/Organization/"
...
| Property | Value |
| --- | --- |
| Class URI | [schema:ResearchOrganization](http://schema.org/ResearchOrganization) |
...
| ---  | ---  |
| self | schema:ResearchOrganization |
| native | idhi:ResearchCenter |
