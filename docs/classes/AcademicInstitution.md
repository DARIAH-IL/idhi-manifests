...
URI: [schema:CollegeOrUniversity](http://schema.org/CollegeOrUniversity)
...
```mermaid
 classDiagram
    ...
    click AcademicInstitution href "../../classes/AcademicInstitution/"
      ...
      AcademicInstitution : additional_urls
        
      AcademicInstitution : contact_email
        
      AcademicInstitution : description
        
          
    
        
        
        AcademicInstitution --> "*" LangString : description
        click LangString href "../../classes/LangString/"
    

        
      AcademicInstitution : homepage
        
      AcademicInstitution : id
        
      AcademicInstitution : identifiers
        
      AcademicInstitution : location
        
          
    
        
        
        AcademicInstitution --> "0..1" Location : location
      ...
      AcademicInstitution : name
        ...
        AcademicInstitution --> "*" LangString : name
        click LangString href "../../classes/LangString/"
    

        
      AcademicInstitution : organization_type
        
          
    
        
        
        AcademicInstitution --> "0..1" OrganizationTypeEnum : organization_type
        click OrganizationTypeEnum href "../../enums/OrganizationTypeEnum/"
    

        
      AcademicInstitution : parent_organization
        
          
    
        
        
        AcademicInstitution --> "0..1" Organization : parent_organization
        click Organization href "../../classes/Organization/"
    

        
      AcademicInstitution : ror
        
      AcademicInstitution : same_as
        
      AcademicInstitution : type
...
| Property | Value |
| --- | --- |
| Class URI | [schema:CollegeOrUniversity](http://schema.org/CollegeOrUniversity) |
...
| native | idhi:AcademicInstitution |
