...
| [NamedThing](classes/NamedThing.md) | Root class for any identifiable IDHI entity |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Agent](classes/Agent.md) | A person or organization (a FOAF Agent) |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Organization](classes/Organization.md) | An organization of any kind |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[AcademicInstitution](classes/AcademicInstitution.md) | A university or college |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Company](classes/Company.md) | A commercial company |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Funder](classes/Funder.md) | A funding body (foundation, council, government program) |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[GLAMInstitution](classes/GLAMInstitution.md) | A gallery, library, archive or museum |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[NonProfit](classes/NonProfit.md) | A non-profit / NGO |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[ResearchCenter](classes/ResearchCenter.md) | A research center or institute |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Person](classes/Person.md) | A human agent in the DH index: researcher, developer, librarian, student, etc |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Catalog](classes/Catalog.md) | A digital archive / catalog of resources (DCAT Catalog), i |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Dataset](classes/Dataset.md) | A dataset produced or curated by a project (DCAT Dataset): corpora, databases... |
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Location](classes/Location.md) | A place, optionally with geographic coordinates |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Project](classes/Project.md) | A Digital Humanities research project, classified by TaDiRAH research activit... |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Publication](classes/Publication.md) | An academic publication (BIBO document): journal article, book, chapter, conf... |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Service](classes/Service.md) | A reusable, human- or organization-mediated service offered by a facility or ... |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[TimePeriod](classes/TimePeriod.md) | A time span (EDM TimeSpan) |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Tool](classes/Tool.md) | A reusable software tool, typically produced by a project (schema:SoftwareApp... |
| [Relationship](classes/Relationship.md) | Abstract base for reified, role-bearing relationships, following the CERIF li... |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Affiliation](classes/Affiliation.md) | A person's employment/membership at an organization, with a position and date... |
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[OrganizationProjectRole](classes/OrganizationProjectRole.md) | An organization's engagement in a project (CERIF cfProject_OrganisationUnit) |
...
| [begin_date](slots/begin_date.md) | Start of the time span |
| [catalogs](slots/catalogs.md) | All Catalog records in the index |
...
| [datasets](slots/datasets.md) | The datasets this catalog aggregates (by id) |
...
| [doi](slots/doi.md) | The publication's DOI, as CURIE (DOI:10 |
| [emails](slots/emails.md) | Contact email addresses (zero or more) |
| [end_date](slots/end_date.md) | End of the event, relationship or time period |
...
| [funding_amount](slots/funding_amount.md) | Total awarded funding, if public, in ILS unless noted in the project descript... |
...
| [identifiers](slots/identifiers.md) | Additional EXTERNAL identifiers beyond the primary IDHI URN and the dedicated... |
| [language](slots/language.md) | BCP-47 language tag of the value (en, he or ar) |
| [latitude](slots/latitude.md) | WGS84 latitude in decimal degrees |
| [license](slots/license.md) | The license under which the tool or dataset is released |
| [location](slots/location.md) | Where the organization, facility or event is physically situated |
| [locations](slots/locations.md) | All Location records in the index |
| [longitude](slots/longitude.md) | WGS84 longitude in decimal degrees |
| [member](slots/member.md) | The person affiliated with the organization (by IDHI URN) |
| [name](slots/name.md) | Multilingual name/title |
| [orcid](slots/orcid.md) | The person's ORCID iD, as CURIE (ORCID:0000-0002-1825-0097) or full URL |
...
| [project_period](slots/project_period.md) | The project's OWN runtime (when the research is/was conducted) |
...
| [publisher](slots/publisher.md) | The organization publishing the catalog, dataset or publication (by IDHI URN) |
...
| [ror](slots/ror.md) | The organization's ROR ID, as CURIE (ROR:04aj4c181) or full URL |
...
| [start_date](slots/start_date.md) | Start of the event or of a relationship's validity (e |
| [studied_periods](slots/studied_periods.md) | Historical period(s) the project studies (e |
| [studied_places](slots/studied_places.md) | Geographic focus of the research (places studied), as Location records — dist... |
| [themes](slots/themes.md) | Thematic keywords for the catalog/dataset, multilingual |
| [time_periods](slots/time_periods.md) | All TimePeriod records in the index |
...
| [DigitalHumanitiesActivityEnum](enums/DigitalHumanitiesActivityEnum.md) | Digital-humanities research activities, as any TaDiRAH 2 |
...
| [PublicationTypeEnum](enums/PublicationTypeEnum.md) | The kind of publication, as any concept from the COAR Resource Types vocabula... |
